            ...
            <div className="v-section">
              ...
              <div className="v-strips-container">
                ...
                {[
                  ...
                  { data: tours, title: 'Tour', icon: '🧭', render: (item: any) => <><div className="v-col-full"><strong>Titular:</strong> {item.passengerName}</div><div><strong>Tour:</strong> {item.selectedTour}</div><div><strong>Fecha:</strong> {item.preferredDate ? formatDate(item.preferredDate) : ''}</div></> },
